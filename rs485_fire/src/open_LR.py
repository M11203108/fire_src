...
def main():
    ...
    save_calibration_result('/home/robot/wheeltec_ros2/src/rs485_fire/src/calibration_LR.json', calibration_result)
    print("Calibration results saved to /home/robot/wheeltec_ros2/src/rs485_fire/src/calibration_LR.json")
