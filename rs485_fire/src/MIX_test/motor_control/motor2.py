...
LR_result = load_calibration_result('/home/robot/wheeltec_ros2/src/rs485_fire/src/calibration_LR.json')
if LR_result:
...
if __name__ == "__main__":
    ...
    if not motor.connect():
        ...
        try:
            # 載入校準結果
            calibration_result = load_calibration_result('/home/robot/wheeltec_ros2/src/rs485_fire/src/calibration_LR.json')
