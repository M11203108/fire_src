...
def generate_launch_description():
    ...
    d435i_dir = get_package_share_directory('realsense2_camera')
    imu_dir = os.path.join(d435i_dir, 'launch')
...
#     imu_open = IncludeLaunchDescription(
#                 PythonLaunchDescriptionSource(os.path.join(imu_dir, 'rs_launch.py')),
# )
