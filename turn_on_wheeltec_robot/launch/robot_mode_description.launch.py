...
def generate_launch_description():
    ...
    mini_4wd = GroupAction([
            generate_robot_node('mini_4wd_robot.urdf'),
    ...
    mini_4wd_two_laser = GroupAction([
            generate_robot_node('mini_4wd_robot.urdf'),
            generate_static_transform_publisher_node(['0.435', '-0.3285', '0.2'], ['-1.5707', '3.1415926', '0'], 'base_footprint', 'laser_1'),
            generate_static_transform_publisher_node(['-0.435', '0.3285', '0.2'], ['1.5707', '3.1415926', '0'], 'base_footprint', 'laser_2'),
        #     generate_static_transform_publisher_node(['0.0', '0', '0.25'], ['0', '0', '0'], 'base_footprint', 'camera_link'),
    ])                
